...
import { checkPhone, getToken, sendTokenToSMS } from './phone.js' // export 골라서 가져오기
// import qqq from './phone.js'                                      // export default 가져오기
// import express from 'express'                                     // export default 가져오기
// import askldfjklasdjfskladj from 'express'                        // export default 이름바꿔서 가져오기
// import qqq, {checkPhone as zzzz, getToken} from './phone.js'      // export default와 export를 함께 쓰기

// import * as ttt from './phone.js'                                 // export 한방에 다 묶어서 가져오기
// ttt.checkPhone()                                                  // export 한방에 다 묶어서 가져오기
// ttt.getToken()                                                    // export 한방에 다 묶어서 가져오기
